...
public class tinydb {
    ...
    public ArrayList<datensatzeintrag> getListObject(String key, ArrayList<datensatzeintrag> mmClass){
        Gson gson = new Gson();
        Class mClass=datensatzeintrag.class;
        ArrayList<String> objStrings = getListString(key);
        ArrayList<datensatzeintrag> objects =  new ArrayList<datensatzeintrag>();

        for(String jObjString : objStrings){
            datensatzeintrag value  = gson.fromJson(jObjString, (Type) mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<datensatzeintrag_mit_datum> getListObject_new(String key, ArrayList<datensatzeintrag_mit_datum> mmClass){
        Gson gson = new Gson();
        Class mClass= datensatzeintrag_mit_datum.class;
        ArrayList<String> objStrings = getListString(key);
        ArrayList<datensatzeintrag_mit_datum> objects =  new ArrayList<datensatzeintrag_mit_datum>();

        for(String jObjString : objStrings){
            datensatzeintrag_mit_datum value  = gson.fromJson(jObjString, (Type) mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<datensatzstamm> getListObj(String key, ArrayList<datensatzstamm> mmClass){
        Gson gson = new Gson();
        Class mClass=datensatzstamm.class;
        ArrayList<String> objStrings = getListString(key);
        ArrayList<datensatzstamm> objects =  new ArrayList<datensatzstamm>();

        for(String jObjString : objStrings){
            datensatzstamm value  = gson.fromJson(jObjString, (Type) mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<datensatzeintrag> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public void putListObject_new(String key, ArrayList<datensatzeintrag_mit_datum> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
    ...
    public void putListObj(String key, ArrayList<datensatzstamm> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
